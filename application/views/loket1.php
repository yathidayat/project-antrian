      ...
      <div class="col-md-12">
        <div class="card loket-card">
          <div class="card-header bg-primary text-white">
            <span>Daftar Antrian Loket 1</span>
  ...
  <script>
    ...
    function playSound(nomor, kode_loket) {
      ...
      audio.onended = function() {
        var message = new SpeechSynthesisUtterance("Nomor antrian " + numberToWords(nomor) + ' ' + kode_loket + ' .Silakan menuju loket.' + 'KASIR');
        message.lang = 'id-ID';
    ...
    function updateAntrian(id, action) {
      ...
      $.ajax({
        url: '<?php echo base_url('antrian/update_antrian/K'); ?>',
        type: 'POST',
        data: {
          id: id,
          action: action
    ...
    function refreshAntrianData() {
      ...
      $.ajax({
        url: '<?php echo base_url('dashboard/get_antrian_loket/K'); ?>',
        type: 'GET',
