...
<body>
      ...
      <div class="col-md-12">
        <div class="card loket-card">
          <div class="card-header bg-primary text-white">
            <span>Daftar Antrian Loket 5</span>
  ...
  <script>
    ...
    //   var utterance = new SpeechSynthesisUtterance('Nomor antrian ' + ('000' + nomorAntrian).slice(-3) + ' untuk loket ' + 'E-COURT' + '. Silakan menuju loket.');
    ...
    function playSound(nomor, kode_loket) {
      ...
      audio.onended = function() {
        var message = new SpeechSynthesisUtterance("Nomor antrian " + numberToWords(nomor) + ' ' + kode_loket + ' .Silakan menuju loket.' + 'E-COURT');
        message.lang = 'id-ID';
    ...
    function updateAntrian(id, action) {
      ...
      $.ajax({
        url: '<?php echo base_url('antrian/update_antrian/E'); ?>',
        type: 'POST',
        data: {
          id: id,
          action: action
    ...
    function refreshAntrianData() {
      ...
      $.ajax({
        url: '<?php echo base_url('dashboard/get_antrian_loket/E'); ?>',
        type: 'GET',
